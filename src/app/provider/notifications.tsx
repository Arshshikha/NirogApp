...
const BackIcon = ({ color = '#059669', size = 16 }: { color?: string; size?: number }) => (
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#f0f9ff' }} edges={['top']}>
      ...
      <View style={{
        ...
        shadowColor: '#10b981', shadowOpacity: 0.08, shadowRadius: 8, elevation: 3, marginTop: -36,
      }}>
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
          <TouchableOpacity
            ...
            style={{
              ...
              borderWidth: 1.5, borderColor: '#a7f3d0', marginTop: 28
            }}
          >
            <BackIcon color="#059669" size={14} />
          </TouchableOpacity>
        ...
        {unreadCount > 0 && (
          <TouchableOpacity
            ...
            style={{
              ...
              borderWidth: 1.2, borderColor: '#34d399', marginTop: 28
            }}
          >
            <Text style={{ color: '#059669', fontSize: 9, fontWeight: '800', textTransform: 'uppercase' }}>
              Mark All Read
            </Text>
          </TouchableOpacity>
        )}
            ...
            notifications.map((notif) => (
              <TouchableOpacity
                ...
                style={{
                  ...
                  borderColor: notif.isRead ? '#e0f2fe' : '#34d399',
                  borderRadius: 20, padding: 16, marginBottom: 12,
                  flexDirection: 'row', alignItems: 'center',
                  shadowColor: '#10b981', shadowOpacity: 0.05, shadowRadius: 6, elevation: 1,
                  position: 'relative'
                }}
              >
                ...
                {!notif.isRead && (
                  <View style={{
                    ...
                    backgroundColor: '#059669', position: 'absolute',
                    top: 16, right: 16
                  }} />
                )}
              </TouchableOpacity>
